...
아래는 수소차량수, 사무실밀집도, 통근통학인구, 생활인구, 전체교통량, 출근교통량, 퇴근교통량, 인구밀도, 건축물밀집도, 화재발생, 혼잡빈도, 혼잡시간, 공시지가 총 14개 입지선정변수이다.
...
#| echo: false
#| fig-cap: '생활인구'
m_4 = folium.Map(location = [35.1796, 129.0750], tiles='CartoDB positron', zoom_start = 10)
...
```{python}
#| echo: false
m_5 = folium.Map(location = [35.1796, 129.0750], tiles='Stamen Terrain', zoom_start = 10)
...
folium.LayerControl('topleft').add_to(m_5)
